let frontDomain = process.env.TOKEN_FRONT_DOMAIN ? process.env.TOKNE_FRONT_DOMAIN : "http://token.vaiwan.com"
let backendDomain = process.env.TOKEN_BACKEND_DOMAIN ? process.env.TOKEN_BACKEND_DOMAIN : "http://localhost:8000"
